        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          <Card className="relative hover:shadow-lg transition-shadow border-2 border-purple-200">
            ...
            <CardContent className="space-y-4">
              ...
              <Button className="w-full bg-purple-600 hover:bg-purple-700 text-white">Adicionar ao Plano</Button>
            </CardContent>
          </Card>
          ...
          <Card className="relative hover:shadow-lg transition-shadow border-2 border-green-200">
            ...
            <CardContent className="space-y-4">
              ...
              <Button className="w-full bg-green-600 hover:bg-green-700 text-white">Adicionar ao Plano</Button>
            </CardContent>
          </Card>
        </div>
      </div>
