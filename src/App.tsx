...
import { AddOnsSection } from "./app/components/add-ons-section";
import { OnboardingPreviewSection } from "./app/components/onboarding-preview-section";
import { AdCreationStepper } from "./app/components/ad-creation-stepper";
import WaitingListSection from "./app/components/waiting-list-section";
import "./App.css";
        ...
        <div className="relative container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              >
                <a href="#waiting-list">Experimente Grátis</a>
              </Button>
              <a
                href="#precos"
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            <Card className="relative">
              ...
              <CardContent className="space-y-4">
                ...
                >
                  <a href="#waiting-list">Assinar Agora</a>
                </Button>
              </CardContent>
            </Card>
